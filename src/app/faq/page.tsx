          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link
                ...
                className="px-5 py-2 rounded-full bg-white/5 border border-pink-500/20 text-gray-200 hover:text-white hover:bg-white/10 transition-all text-sm"
              >
                Physician Loans
              </Link>
              <Link
                href="/first-time-buyers"
                className="px-5 py-2 rounded-full bg-white/5 border border-cyan-500/20 text-gray-200 hover:text-white hover:bg-white/10 transition-all text-sm"
              >
                First-Time Buyers
              </Link>
              <Link
                href="/self-employed"
                className="px-5 py-2 rounded-full bg-white/5 border border-purple-500/20 text-gray-200 hover:text-white hover:bg-white/10 transition-all text-sm"
              >
                Self-Employed
              </Link>
              <Link
                href="/loan-solutions"
                className="px-5 py-2 rounded-full bg-white/5 border border-teal-500/20 text-gray-200 hover:text-white hover:bg-white/10 transition-all text-sm"
              >
                All Loan Options
              </Link>
              <Link
                href="/about"
                className="px-5 py-2 rounded-full bg-white/5 border border-white/20 text-gray-200 hover:text-white hover:bg-white/10 transition-all text-sm"
              >
                About Maggie
              </Link>
            </div>
