        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {copy.refinanceTypes.types.map((type, index) => (
            ...
            >
              ...
              <p className="text-gray-100 text-sm mb-5 leading-relaxed">{type.description}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <GlassCard hover={false} className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-purple-500/20">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-100 text-sm">If you refinanced today</p>
            </div>
            
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="text-center p-4 rounded-xl bg-white/5">
                <p className="text-gray-100 text-xs mb-1">Current Rate</p>
                <p className="text-2xl font-bold text-white">{copy.savings.example.currentRate}%</p>
              </div>
              <div className="text-center p-4 rounded-xl bg-white/5">
                <p className="text-gray-100 text-xs mb-1">New Rate</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 rounded-xl bg-purple-500/10 border border-purple-500/20">
                <p className="text-gray-100 text-xs mb-1">Monthly Savings</p>
              ...
              <div className="text-center p-4 rounded-xl bg-pink-500/10 border border-pink-500/20">
                <p className="text-gray-100 text-xs mb-1">Lifetime Savings</p>
                <p className="text-2xl font-bold text-cyan-400">${copy.savings.example.lifetimeSavings.toLocaleString()}</p>
              </div>
            </div>
            
            <p className="text-xs text-gray-100 mt-4 text-center">
            ...
            <GlassCard key={index} hover delay={index * 0.05} className="border-white/5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-100 text-xs leading-relaxed">{item.description}</p>
                </div>
              </div>
            </GlassCard>
          ))}
