...
export default function InsurancePage() {
  return (
    <>
      <Section background="default" backgroundImage="https://raw.githubusercontent.com/Blank-bluffton/maggie-blank-website/main/public/IMG_4570.JPG" className="relative after:absolute after:inset-0 after:bg-black after:-z-10">
