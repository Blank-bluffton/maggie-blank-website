              ...
              <GlassCard hover className="h-full group">
                ...
                <div className="flex flex-wrap gap-2">
                  {hood.highlights.map((highlight, i) => (
                    <span 
                      key={i}
                      className="px-2.5 py-1 rounded-lg bg-white/5 text-gray-100 text-xs border border-white/10"
                    >
                      {highlight}
                    </span>
                  ))}
                  ...
                  <GlassCard hover={false} className="p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-100 text-sm">{tip.description}</p>
                      </div>
                    </div>
                  </GlassCard>
                </motion.div>
      ...
      <Section background="gradient">
        <div className="text-center">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="text-gray-100 text-lg max-w-xl mx-auto mb-8"
          >
            {copy.cta.subhead}
          </motion.p>
          <motion.div 
