        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-gray-100 text-sm">
                New Construction
              </span>
              <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-gray-100 text-sm">
                Golf Communities
          ...
          {[
            ...
            >
              <GlassCard hover={false} className="text-center py-6">
                ...
                <p className="text-gray-100 mt-1 text-sm">{stat.label}</p>
              </GlassCard>
            </motion.div>
          ))}
        </div>
              ...
              <GlassCard hover className="h-full group">
                ...
                <div className="flex flex-wrap gap-2">
                  {neighborhood.highlights.map((highlight, i) => (
                    <span 
                      key={i}
                      className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-100 text-sm flex items-center gap-1.5"
                    >
