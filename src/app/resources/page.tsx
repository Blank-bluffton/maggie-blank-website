                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-lg font-semibold text-gray-900 group-hover:text-cyan-400 transition-colors">
                        {card.title}
                      </h3>
                      <ChevronRight className="w-5 h-5 text-gray-900 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" />
                    </div>
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gray-800/50 flex items-center justify-center flex-shrink-0">
                    <item.icon className="w-6 h-6 text-gray-900 group-hover:text-cyan-400 transition-colors" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="text-gray-900 font-medium group-hover:text-cyan-400 transition-colors">
                        {item.title}
                      </h3>
                      <span className="px-2 py-0.5 bg-gray-800 text-gray-900 text-xs rounded-full">
                        {item.tag}
                      </span>
                    </div>
