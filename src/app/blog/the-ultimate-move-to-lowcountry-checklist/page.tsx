            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-100 text-sm">The fastest-growing town in South Carolina. Offers a mix of master-planned communities (like Belfair, Hampton Lake, Palmetto Bluff), historic Old Town, and easy access to Hilton Head. Great for families and retirees alike. Median home prices: $400K-$700K.</p>
                </div>
                <div>
                  <h4 className="text-white font-medium mb-2">Hilton Head Island</h4>
                  <p className="text-gray-100 text-sm">World-renowned resort island with 12 golf courses, pristine beaches, and exclusive communities. Higher price points and more resort-oriented. Ideal for second homes, retirees, and golf enthusiasts. Median home prices: $500K-$1.2M+.</p>
                </div>
                <div>
                  <h4 className="text-white font-medium mb-2">Beaufort</h4>
                  <p className="text-gray-100 text-sm">Historic waterfront town with Southern charm, excellent restaurants, and rich history. More affordable than Bluffton or Hilton Head. Great for those who want authentic Lowcountry character. Median home prices: $350K-$550K.</p>
                </div>
                <div>
                  <h4 className="text-white font-medium mb-2">Okatie/Hardeeville</h4>
                  <p className="text-gray-100 text-sm">Up-and-coming areas with new developments and more affordable options. Growing rapidly with new shopping and amenities. Good for budget-conscious buyers. Median home prices: $300K-$450K.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-cyan-500/10 rounded-xl p-6 border border-cyan-500/30 mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-gray-100 text-sm">Check FEMA maps and elevation certificates</p>
                </div>
                <div className="text-center">
                  <TreePine className="w-8 h-8 text-cyan-400 mx-auto mb-2" />
                  <p className="text-white font-medium">HOA Fees</p>
                  <p className="text-gray-100 text-sm">Range from $200-$1,500+/year depending on community</p>
                </div>
                <div className="text-center">
                  <Building className="w-8 h-8 text-cyan-400 mx-auto mb-2" />
                  <p className="text-white font-medium">Property Taxes</p>
                  <p className="text-gray-100 text-sm">Avg 0.6-0.8% of assessed value in Beaufort County</p>
                </div>
              </div>
            </div>
