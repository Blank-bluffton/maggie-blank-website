              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200 text-sm">No down payment required for qualified physicians</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  <div>
                    ...
                    <p className="text-gray-200 text-sm">5% down payment with no PMI</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  <div>
                    ...
                    <p className="text-gray-200 text-sm">10% down payment for more flexibility</p>
                  </div>
                </div>
              </div>
            </GlassCard>
