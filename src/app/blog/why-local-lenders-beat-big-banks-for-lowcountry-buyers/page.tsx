              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-100 text-sm">Get a verified pre-approval letter the same day you apply—no waiting 24-48 hours.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <ClockIcon className="w-5 h-5 text-cyan-400 mt-1" />
                  <div>
                    ...
                    <p className="text-gray-100 text-sm">When questions arise, I can pick up the phone and speak directly to the decision-maker—not wait for email chains.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <ClockIcon className="w-5 h-5 text-cyan-400 mt-1" />
                  <div>
                    ...
                    <p className="text-gray-100 text-sm">We work with your timeline—not the bank's processing schedule.</p>
                  </div>
                </div>
              </div>
            </div>
