      ...
      <Section background="dark">
        <div className="max-w-4xl mx-auto">
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">1. We Know the Lowcountry Market Inside and Out</h2>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3 text-gray-900">
                ...
                <span><strong className="text-gray-900">Coastal property considerations:</strong> Flood zones, wind mitigation requirements, and insurance implications vary dramatically by neighborhood. A local lender knows that a home in Sea Pines might require different insurance than one in Sun City.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Golf community requirements:</strong> Many Lowcountry communities have specific HOA financial requirements that can affect your financing. Local lenders have seen these scenarios repeatedly.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Local property values:</strong> We know the neighborhoods—Belfair versus Hampton Lake versus Palmetto Bluff. We understand what drives value in each community and can accurately assess properties.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Closing timeline expectations:</strong> We've worked with local attorneys, title companies, and real estate agents. We know who moves fast and who causes delays.</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">2. Faster Decisions and Faster Closings</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">The Local Lender Advantage</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <ClockIcon className="w-5 h-5 text-cyan-400 mt-1" />
                  <div>
                    <span className="text-gray-900 font-medium">Same-day pre-approval</span>
                    <p className="text-gray-900 text-sm">Get a verified pre-approval letter the same day you apply—no waiting 24-48 hours.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <ClockIcon className="w-5 h-5 text-cyan-400 mt-1" />
                  <div>
                    <span className="text-gray-900 font-medium">Direct access to underwriters</span>
                    <p className="text-gray-900 text-sm">When questions arise, I can pick up the phone and speak directly to the decision-maker—not wait for email chains.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <ClockIcon className="w-5 h-5 text-cyan-400 mt-1" />
                  <div>
                    <span className="text-gray-900 font-medium">Flexible closing dates</span>
                    <p className="text-gray-900 text-sm">We work with your timeline—not the bank's processing schedule.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">3. More Flexible Financing Options</h2>
            <p className="text-gray-900 mb-6">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3 text-gray-900">
                ...
                <span><strong className="text-gray-900">Physician loan programs:</strong> Specialized programs for doctors with deferred student debt, contract employment, or income that doesn't fit traditional W-2 templates.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <Shield className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Self-employed financing:</strong> Bank statement programs, K-1 analysis, and alternative documentation options that big banks often reject.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <Shield className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Construction financing:</strong> Local lenders often have established construction-to-permanent loan programs with local builders.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <Shield className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Jumbo loans:</strong> For high-value Lowcountry properties, local lenders may offer more competitive jumbo pricing than big banks.</span>
              </li>
            </ul>
            <p className="text-gray-900 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">4. Personal Service from Someone Who Lives Here</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Big Bank Reality</h3>
              ...
              <div className="bg-cyan-500/10 rounded-xl p-6 border border-cyan-500/30">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Local Lender Experience</h3>
                <ul className="space-y-3 text-gray-900 text-sm">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">5. Stronger Relationships with Local Partners</h2>
            <p className="text-gray-900 mb-6">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3 text-gray-900">
                ...
                <span><strong className="text-gray-900">Real Estate Agents:</strong> Listing agents in the Lowcountry know which lenders close on time and which cause problems. Working with a local lender with a proven track record strengthens your offer.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <MapPin className="w-5 h-5 text-cyan-400 mt-1" />
                <span><strong className="text-gray-900">Attorneys and Title Companies:</strong> We know the local attorneys who are responsive and thorough. These relationships smooth out the closing process.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <MapPin className="w-5 h-5 text-cyan-400 mt-1" />
                <span><strong className="text-gray-900">Appraisers:</strong> We know which appraisers understand Lowcountry property values and can provide accurate assessments—critical in a market where coastal and golf community properties require specialized knowledge.</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">6. Competitive Rates Without the Big Bank Overhead</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-xl p-8 border border-cyan-500/30 mt-12">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Experience the Local Lender Difference</h3>
              <p className="text-gray-900 mb-6">
