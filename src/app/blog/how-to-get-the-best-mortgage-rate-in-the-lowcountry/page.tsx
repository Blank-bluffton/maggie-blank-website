          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 mb-8">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="text-white">No Points (7.0%):</div>
                <div className="text-white font-medium">$2,661/month</div>
                <div className="text-white">2 Points Paid ($8,000):</div>
                <div className="text-white font-medium">$2,523/month</div>
                <div className="text-white col-span-2 pt-4 border-t border-gray-700">
                  <span className="text-cyan-400">Monthly Savings: $138</span>
                  <br />
                  <span className="text-white">Break-even: 58 months</span>
                </div>
              </div>
            </div>
            <p className="text-white mb-6">
