      ...
      <Section background="dark">
        <div className="max-w-4xl mx-auto">
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Understanding What Drives Your Mortgage Rate</h2>
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3 text-gray-900">
                ...
                <span><strong className="text-gray-900">Credit Score:</strong> Your credit score is the single biggest factor in determining your rate. Scores above 740 typically qualify for the best rates, while scores below 620 may see significant rate increases.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Down Payment Amount:</strong> Larger down payments reduce lender risk and often qualify for better rates. Putting down 20% or more can meaningfully improve your pricing.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Loan Type:</strong> Conventional loans, FHA loans, and physician loans all have different rate structures. Physician loans in particular can offer competitive pricing for medical professionals.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Debt-to-Income Ratio:</strong> Lower DTI ratios signal lower risk to lenders and typically result in better rate offers.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Property Type:</strong> Primary residence, second home, or investment property each have different rate classifications.</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Strategy 1: Improve Your Credit Before You Apply</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Quick Credit Boosters</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Strategy 2: Work with a Local Lender Who Knows the Lowcountry Market</h2>
            <p className="text-gray-900 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Strategy 3: Consider Paying Points to Buy Down Your Rate</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Example: Points on a $400,000 Loan</h3>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="text-gray-900">No Points (7.0%):</div>
                <div className="text-gray-900 font-medium">$2,661/month</div>
                <div className="text-gray-900">2 Points Paid ($8,000):</div>
                <div className="text-gray-900 font-medium">$2,523/month</div>
                <div className="text-gray-900 col-span-2 pt-4 border-t border-gray-700">
                  <span className="text-cyan-400">Monthly Savings: $138</span>
                  <br />
                  <span className="text-gray-900">Break-even: 58 months</span>
                </div>
              </div>
            </div>
            <p className="text-gray-900 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Strategy 4: Timing Matters—But Don't Try to Time the Market</h2>
            <p className="text-gray-900 mb-6">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-3 text-gray-900">
                ...
                <span><strong className="text-gray-900">Year-end typically sees rate drops:</strong> December often brings competitive pricing as lenders meet annual goals.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <TrendingDown className="w-5 h-5 text-cyan-400 mt-1" />
                <span><strong className="text-gray-900">Avoid rate locks in volatile periods:</strong> If rates are swinging significantly, shorter lock periods may be safer.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <TrendingDown className="w-5 h-5 text-cyan-400 mt-1" />
                <span><strong className="text-gray-900">Get pre-approved early:</strong> This gives you time to rate shop without rushing.</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Strategy 5: Explore Physician Loan Programs</h2>
            <p className="text-gray-900 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">The Bottom Line: Rate Shopping Matters</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-xl p-8 border border-cyan-500/30 mt-12">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Ready to Explore Your Rate Options?</h3>
              <p className="text-gray-900 mb-6">
