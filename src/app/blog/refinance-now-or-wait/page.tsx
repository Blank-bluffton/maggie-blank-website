              ...
              <GlassCard key={index} hover={false}>
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-gray-100 text-sm">{item.note}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-2xl font-bold text-cyan-400">{item.current}</p>
                    <p className="text-gray-100 text-sm flex items-center gap-1 justify-end">
          ...
          <div className="space-y-4">
            {copy.shouldYouRefinance.scenarios.map((scenario, index) => (
              <GlassCard key={index} hover={false}>
                ...
                <p className="text-gray-100">{scenario.description}</p>
              </GlassCard>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            {copy.lowcountryFactors.factors.map((factor, index) => (
              <GlassCard key={index} hover delay={index * 0.1}>
                ...
                <p className="text-gray-100 text-sm">{factor.description}</p>
              </GlassCard>
            ))}
          </div>
        </div>
          ...
          <div className="space-y-4 mt-8">
            {copy.types.options.map((option, index) => (
              <GlassCard key={index} hover={false}>
                ...
                <p className="text-gray-100 text-sm mb-3">{option.description}</p>
