      ...
      <Section background="dark">
        <div className="max-w-4xl mx-auto">
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">What Are Closing Costs?</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Breaking Down South Carolina Closing Costs</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">South Carolina Transfer Tax: A Unique Consideration</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Transfer Tax Rates in South Carolina</h3>
              <ul className="space-y-3 text-gray-900">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1" />
                  <span><strong className="text-gray-900">State deed stamps:</strong> $3.70 per $1,000 of purchase price</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1" />
                  <span><strong className="text-gray-900">County documentary fees:</strong> Varies by county—Beaufort County is $1.10 per $1,000</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1" />
                  <span><strong className="text-gray-900">Total effective rate:</strong> Approximately 0.7-1.1% depending on county</span>
                </li>
              </ul>
            </div>
            <p className="text-gray-900 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Lowcountry-Specific Considerations</h2>
            <p className="text-gray-900 mb-6">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3 text-gray-900">
                ...
                <span><strong className="text-gray-900">Flood Insurance Requirements:</strong> If your property is in a flood zone (common in coastal areas near Hilton Head and Beaufort), you'll likely need flood insurance. This can cost $500-$2,000+ annually and must often be prepaid at closing.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Wind/Hurricane Insurance:</strong> Coastal properties often require wind mitigation insurance, which can add $500-$1,500 annually to your insurance costs.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">HOA Capital Contributions:</strong> Many Lowcountry communities—especially in golf communities and marsh-front developments—require one-time capital contribution fees ranging from $500 to several thousand dollars.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <CheckCircle2 className="w-5 h-5 text-cyan-400 mt-1 flex-shrink-0" />
                <span><strong className="text-gray-900">Dock/Marina Fees:</strong> If you're buying property with water access or boat slip rights, there may be additional fees to consider.</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Who Pays What in South Carolina?</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 mb-8">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Buyer Typically Pays</h3>
                  <ul className="space-y-2 text-sm text-gray-900">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Seller Typically Pays</h3>
                  <ul className="space-y-2 text-sm text-gray-900">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Can You Negotiate Closing Costs?</h2>
            <p className="text-gray-900 mb-6">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3 text-gray-900">
                ...
                <span><strong className="text-gray-900">Request a Loan Estimate comparison:</strong> Get quotes from multiple lenders and ask them to match or beat competitor pricing on origination fees.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <PenTool className="w-5 h-5 text-cyan-400 mt-1" />
                <span><strong className="text-gray-900">Ask for lender credits:</strong> Some lenders will provide a credit toward closing costs in exchange for a slightly higher interest rate.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <PenTool className="w-5 h-5 text-cyan-400 mt-1" />
                <span><strong className="text-gray-900">Shop for title services:</strong> You're not required to use the title company your lender recommends. Getting multiple quotes can save hundreds.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-900">
                <PenTool className="w-5 h-5 text-cyan-400 mt-1" />
                <span><strong className="text-gray-900">Time your closing:</strong> Scheduling your closing early in the month reduces the prepaid interest you'll owe.</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Estimating Your Closing Costs</h2>
            <p className="text-gray-900 mb-6">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-700">
                      <th className="text-left py-3 text-gray-900 font-semibold">Purchase Price</th>
                      <th className="text-right py-3 text-gray-900 font-semibold">Est. Closing Costs</th>
                    </tr>
                  </thead>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">Getting Your Closing Cost Estimate</h2>
            <p className="text-gray-900 mb-6">
            ...
            <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-xl p-8 border border-cyan-500/30 mt-12">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Get Your Personalized Closing Cost Estimate</h3>
              <p className="text-gray-900 mb-6">
